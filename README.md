...
indian-road-condition-detector/
│
├── Untitled5__1_.ipynb     # Full training + evaluation notebook
...
│   ├── labels/train/       # YOLO format train labels
│   └── labels/val/         # YOLO format val labels
│
└── runs/detect/model2/
├── weights/best.pt     # Best model weights
├── weights/last.pt     # Last checkpoint (for resume)
